...
HD_PWD='C:/Users/sevin/Desktop/Projects/VHDL/SPI/SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spiMaster.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spiMaster.tcl
